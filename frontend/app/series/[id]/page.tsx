  ...
  return (
    <article>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-32 sm:-mt-48 relative z-10">
        <div className="grid sm:grid-cols-[200px_1fr] lg:grid-cols-[260px_1fr] gap-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm text-text-secondary mb-4">
              ...
              {w.totalEpisode && <span className="text-text-muted text-xs">{w.totalEpisode} eps</span>}
            </div>
        ...
        {/* Rich APK fields: dubs, resource detectors */}
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              ...
              {w.resourceDetectors && w.resourceDetectors.length > 0 && (
                <div className="p-3 rounded bg-bg-tertiary/60">
                  ...
                  <div className="text-xs text-text-muted mt-1">{w.resourceDetectors.length} source{w.resourceDetectors.length > 1 ? 's' : ''}</div>
                </div>
              )}
            </div>
          </section>
